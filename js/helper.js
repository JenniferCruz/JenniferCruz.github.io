...
var googleMap = '<div id="map" class="map-content"></div>';


/*
Generate the custom Google Map for the website.
Documentation at: https://developers.google.com/maps/documentation/javascript/reference
*/
...
function initializeMap() {
    ...
    /*
    For the map to be displayed, the
    googleMap is appended to #mapDiv in resumeBuilder.js,
    and its height is set to 400px
    */
    $("#map").height(400);
    ...
    */
    function locationFinder() {
        ...
        // the locations array. Ignores schools with "Online" as location.
